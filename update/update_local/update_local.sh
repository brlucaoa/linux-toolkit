...
echo "${INFO}Iniciando atualizacao do hermes em producao (LOCAL)...${DFLT}"
...
docker rmi $REGISTRY_LOCAL/$LOCAL_IMAGE 2>/dev/null

echo "${INFO}Carregando imagem nova...${DFLT}"
...
echo "V2=[$V2]"
echo "V3=[$V3]"
echo "IMAGE=[$REGISTRY_LOCAL/$LOCAL_IMAGE]"
